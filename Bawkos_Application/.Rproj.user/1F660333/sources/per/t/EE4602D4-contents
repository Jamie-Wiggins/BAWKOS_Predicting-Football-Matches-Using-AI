...
source("RF/regression_rf.R")
predict_xGNS_ovr_H <- xG_rf_ns_list[[2]]
predict_xGNS_H <- xG_rf_ns_list[[1]]
predict_xGNS_ovr_A <- xG_rf_ns_list[[4]]
predict_xGNS_A  <- xG_rf_ns_list[[3]]
...
summarised_table$ELO_H <- playing_statistics$ELO_H
summarised_table$ELO_A <- playing_statistics$ELO_A
...
# Delete first season used to calculate form for each team to avoid inaccruaries due to form calculations
...
#Write class features for Random Forest
